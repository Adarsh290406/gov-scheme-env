...
QUESTION_RELEVANCE = {
    ActionType.ASK_OCCUPATION:      0.056,
    ActionType.ASK_INCOME:          0.051,
    ActionType.ASK_BPL:             0.051,
    ActionType.ASK_LOCATION:        0.039,
    ActionType.ASK_GENDER:          0.034,
    ActionType.ASK_CASTE:           0.034,
    ActionType.ASK_DISABILITY:      0.028,
    ActionType.ASK_AGE:             0.023,
    ActionType.ASK_EDUCATION:       0.028,
    ActionType.ASK_BANK_ACCOUNT:    0.023,
    ActionType.ASK_RATION_CARD:     0.023,
    ActionType.ASK_MARITAL_STATUS:  0.017,
    ActionType.ASK_LAND_OWNERSHIP:  0.028,
    ActionType.ASK_STATE:           0.017,
}
    ...
    def step(self, action: Action) -> StepResult:
        ...
        # ── CASE 2: Recommending a scheme ──
            ...
            if questions_so_far < min_questions:
                ...
                efficiency_bonus = min(0.08, max(0, (self.max_steps - self.state.step_count) * 0.01))
                reward_value = min(0.48, 0.40 + efficiency_bonus)
                reward_reason = (
